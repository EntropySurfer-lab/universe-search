#!/usr/bin/env python3
# Universe Search v2.3 - Information-Aware Evolution Wrapper
...
OUT_DIR = Path('universe_search_v23_results')
...
def main():
    ...
    if mode in ('evolve', 'search'):
        ...
        print()
        print('Universe Search v2.3 Information-Aware')
        print('=' * 55)
        ...
        print(f'Organism probe   : {ORGANISM_TICKS} ticks, bonus max ~{ORGANISM_BONUS}')
        print(f'Information probe: {INFORMATION_TICKS} ticks, bonus max ~{INFORMATION_BONUS}')
